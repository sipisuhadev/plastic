...
#model = load_model("file.h5",custom_objects={'KerasLayer':hub.KerasLayer})
model = load_model("C:/Users/sipis/Downloads/plastic1-main/plastic1-main/plastic.h5",custom_objects={'KerasLayer':hub.KerasLayer})
labels={
